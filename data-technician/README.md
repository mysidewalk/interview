...
* Application driven solutions to this prompt are acceptable. (For example Excel, QGIS, Tableau, PowerBI, Dreamweaver, Flash). But, we prefer programmatic solutions. (For example, Python, Javascript, R). If you submit a programmatic solution, include your source code. 
